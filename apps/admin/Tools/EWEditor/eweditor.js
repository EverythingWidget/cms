...
EWEditor.prototype.init = function (settings)
{
   ...
   this.editorToolbar.css({zIndex: 1, backgroundColor: '#e0e0e0', position: 'absolute', top: '0px', width: '100%', height: '100px', border: '0px solid #000', borderRadius: '6px'});
...
.column:focus{outline:1px solid #3cf;}\n\
.column:before {content: 'COLUMN';line-height: 20px;display:block;padding:0px 4px;font-size: 11px;font-weight:bold;background-color: rgba(0,0,0,.1);margin:0px -15px;}\n\
   </style>");
...
{
   var self = this;
   var col = $("<div class='col-xs-12 column' tabindex='1'><p>Pharagraph</p></div>");
