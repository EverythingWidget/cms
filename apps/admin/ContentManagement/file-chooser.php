...
global $EW;
EWCore::register_form("ew-file-chooser-form-default", "contents-list", "Contents", get_contents_list());
EWCore::register_form("ew-file-chooser-form-default", "media-list", "Media", "Coming Soon...");
EWCore::register_form("ew-file-chooser-form-default", "apps-pages-list", "Apps", "Coming Soon ... ");
EWCore::register_form("ew-file-chooser-form-default", "widgets-feeders-list", "Widgets Feeders", custom_widget_feeder_tab());
EWCore::register_form("ew-file-chooser-form-default", "custom-url", "URL", custom_url_tab());
