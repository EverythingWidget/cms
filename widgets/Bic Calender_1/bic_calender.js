...
$.fn.bic_calendar = function(options) {
  ...
  this.each(function() {
    ...
    function showCalendar() {
      ...
      var nextMonthButton = $('<td><a href="#" class="btn button-month-next"><i class="glyphicon glyphicon-arrow-right" ></i></a></td>');
      //event
      ...
      var previousMonthButton = $('<td><a href="#" class="btn button-month-previous"><i class="glyphicon glyphicon-arrow-left" ></i></a></td>');
      //event
      ...
      var nextYearButton = $('<td><a href="#" class="btn button-year-next"><i class="glyphicon glyphicon-arrow-right" ></i></a></td>');
      //event
      ...
      var previousYearButton = $('<td><a href="#" class="btn button-year-previous"><i class="glyphicon glyphicon-arrow-left" ></i></a></td>');
      //event
