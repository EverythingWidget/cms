...
(function ($, f) {
   ...
   var Slider = function () {
      ...
      this.move = function (index, cb) {
         ...
         if (!this.items.eq(index).length)
            self.opts.index = 0;
         if (index < 0)
            self.opts.index = (this.items.length - 1);
      ...
      //  Arrow navigation
      this.next = function () {
         return self.stop().move(self.opts.index + 1)
      };
      this.prev = function () {
         return self.stop().move(self.opts.index - 1)
      };
   ...
   $.fn.slider = function (o) {
      ...
      return this.each(function (index) {
         ...
         var element = $(this);
         var instance = (new Slider).init(element, o);

         //  Invoke an Unslider instance
         element.data('slider' + (len > 1 ? '-' + (index + 1) : ''), instance);
      });
   };
})(window.jQuery, false);