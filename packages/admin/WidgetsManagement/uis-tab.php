...
<script  type="text/javascript">
   ...
   UisTab.prototype.uisListDialog = function (onSelect)
   {
      ...
      this.table = EW.createTable({name: "uis-list", headers: {Name: {}, Template: {}}, columns: ["name", "template"], rowCount: true, url: "<?php echo EW_ROOT_URL; ?>app-admin/WidgetsManagement/get_uis_list", pageSize: 30
