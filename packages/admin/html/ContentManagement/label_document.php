   ...
   (function ()
   {
      ...
      text.autocomplete({
         source: function (input) {
            $.post("<?php echo EW_ROOT_URL; ?>admin-api/ContentManagement/get_contents",
                    {
      ...
      $("#{{form_id}}").on("refresh", function (e, formData)
      {
         ...
         $.post("admin-api/ContentManagement/get_content_with_label",
                 {
            ...
            if (data['result'])
               $.each(data['result'], function (i, content)
               {
                  ...
                  if (content.id == formData.id)
                  {
                     ...
                     {
                        $.post("admin-api/ContentManagement/get_article",
                                {
