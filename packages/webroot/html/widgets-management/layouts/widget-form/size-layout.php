<div class="col-xs-12" >
  ...
  <div id="layout-config" class="btn-group btn-group-justified" data-toggle="buttons">
    ...
    <label class="btn btn-default">
      <input type="checkbox" name="clearfix" id="clearfix" value="clearfix" disabled="true"> Clearfix
    </label>
  </div>
</div>
...
<div id="size-and-position-control" class="col-xs-12">
  <h2 class="ta-center">
    Width and Offset
  </h2>
