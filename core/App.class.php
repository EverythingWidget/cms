...
class App {
  ...
  /**
   * Override this method to load your custom assets via <code>read_modules</code> or any other means.
   * This method will be called after reading of default assets and before loading and populating modules stage.
   */
  protected function load_custom_assets() {
  }
